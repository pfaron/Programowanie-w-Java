...
Klasę `HelloWorld`, należy zaimplementować tak, a była uruchamialna jako aplikacja. Należy wyświetlić wszystkie parametry przekazane aplikacji, każdy parametr w nowej linii. W przypadku braku parametrów należy wyświetlić komunikat `No input parameters provided`.
...
W razie odnalezienia dwóch pierwiastków należy zwrócić tablicę o rozmiarze 2 z pierwiastkami. Przy jednym pierwiastku — tablica o rozmiarze 1, przy 0 - tablica o rozmiarze 0.
...
Kolejne elementy w zwracanej tablicy powinny zawierać cały wiersz do wyświetlenia, zaczynając od górnego przy indeksie 0, kończąc na dolnym. Metoda `main` zawiera kod, który umożliwia prawidłowe wyświetlenie wygenerowanego tekstu.
